...
class ConfirmRegistrationScreen extends React.Component {
  ...
  componentWillReceiveProps(nextProps) {
    if (
      nextProps.confirmRegistrationState !==
        this.props.confirmRegistrationState &&
    ...
    return (
      <View style={styles.container}>
        ...
        <Button
          ...
          onPress={() =>
            this.props.dispatch(
              confirmRegistration(this.props.username, this.state.code)
            )}
        />
        {this.props.signUpState === 'CONFIRM_REGISTRATION_REQUEST'
          ? loading
          : null}
      </View>
    );
